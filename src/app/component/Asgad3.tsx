    ...
    <div className="container mx-auto px-4 py-8 flex flex-col justify-center items-center">
      <h2 className="text-2xl font-bold mb-4 flex space-x-6">Description  <div className="ml-8">
        <Link href="/additional-info">
          <a className="hover:text-blue-500 hover:underline text-[#9F9F9F]">Additional Information</a>
        </Link>
        <Link href="/reviews" className="ml-4">
          <a className="hover:text-blue-500 hover:underline text-[#9F9F9F]">Reviews [5]</a>
        </Link>
      </div></h2>
